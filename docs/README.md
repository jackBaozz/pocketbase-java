...
Baseline tracked: PocketBase v0.40.2

The current parity baseline is PocketBase v0.40.2.
...
| 文档 | 说明 |
|---|---|
| [RPD-PocketBase-v0.40.2-Compatibility-Development-Plan.md](RPD-PocketBase-v0.40.2-Compatibility-Development-Plan.md) | **当前 RPD**：官方 v0.40.1 → v0.40.2 的索引名称校验、编辑器前缀补全与防抖、任务分解、验收门禁与执行追踪。 |
