...
public final class TokenService {
  ...
  public Optional<Map<String, Object>> verify(
      String token, Function<Map<String, Object>, String> extraSecretResolver) {
    ...
    try {
      ...
      String extraSecret =
          extraSecretResolver == null ? "" : String.valueOf(extraSecretResolver.apply(claims));
