...
public final class RecordInputProtection {
  ...
  public static JsonNode writableBody(
      CollectionSchema collection, JsonNode body, RequestPrincipal principal) {
  ...
  public static boolean writableField(
      CollectionSchema collection, FieldSchema field, RequestPrincipal principal) {
