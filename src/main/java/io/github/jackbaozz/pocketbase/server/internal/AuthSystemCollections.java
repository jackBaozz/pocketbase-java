...
public final class AuthSystemCollections {
  ...
  public static List<CollectionSchema> defaults() {
    return List.of(authOrigins(), externalAuths(), mfas(), otps());
  }
  ...
  private static void addAutodates(CollectionSchema schema) {
    FieldSchema created =
        new FieldSchema("autodate2990389176", "created", "autodate", false, false, false);
    created.system = true;
    FieldSchema updated =
        new FieldSchema("autodate3332085495", "updated", "autodate", false, false, false);
    updated.system = true;
