...
public final class AuthMailSupport {
    ...
    static SmtpMailer.Message message(
        ...
        String recipient = "emailChange".equals(text(request.get("type")))
    ...
    private static CollectionSchema.EmailTemplate template(CollectionSchema collection, String type) {
        ...
        CollectionSchema.EmailTemplate selected = switch (type) {
            ...
            case "otp" -> collection == null || collection.otp == null ? null : collection.otp.emailTemplate;
            case "authAlert" -> collection == null || collection.authAlert == null ? null : collection.authAlert.emailTemplate;
            default -> null;
        };
        CollectionSchema.EmailTemplate fallback = switch (type) {
    ...
    private static String plainText(String html) {
        return HTML_TAG.matcher(text(html)
                        .replace("<br>", "\n")
                        .replace("<br/>", "\n")
                        .replace("<br />", "\n")
                        .replace("</p>", "\n"))
