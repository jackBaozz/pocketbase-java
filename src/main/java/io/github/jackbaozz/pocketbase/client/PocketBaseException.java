...
/**
 * Runtime exception for non-2xx PocketBase HTTP responses or client transport
 * failures.
 */
public class PocketBaseException extends RuntimeException {
  ...
  PocketBaseException(
      int statusCode, String method, URI uri, String responseBody, PocketBaseError error) {
