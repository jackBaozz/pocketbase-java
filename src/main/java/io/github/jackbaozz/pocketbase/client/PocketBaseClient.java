  ...
  private HttpRequest buildRequest(String method, URI uri, Object body) {
    HttpRequest.Builder builder =
        HttpRequest.newBuilder(uri)
            ...
            .header("User-Agent", "pocketbase-java/0.3.7");
    ...
    builder.method(
        method, HttpRequest.BodyPublishers.ofString(writeJson(body), StandardCharsets.UTF_8));
    return builder.build();
  }

  private PocketBaseException toException(
      String method, URI uri, int statusCode, String responseBody) {
    ...
    return new PocketBaseException(
        statusCode, method, uri, responseBody == null ? "" : responseBody, error);
  }
