...
public final class CollectionsService {
  ...
  public JsonNode scaffolds() {
    return client.send(
        "GET", client.apiPath("collections", "meta", "scaffolds"), Map.of(), null, JsonNode.class);
  }
  ...
  public JsonNode create(Object body) {
    return client.send(
        "POST", client.apiPath("collections"), Map.of(), requireBody(body), JsonNode.class);
  }

  public void importCollections(Object body) {
    client.send(
        "PUT", client.apiPath("collections", "import"), Map.of(), requireBody(body), Void.class);
  }
