...
class PocketBaseClientTest {
    ...
    JsonNode record =
        client
            ...
            .create(
                ...
                RecordQuery.builder().expand("author").fields("id,title").build());
    ...
    JsonNode record =
        client
            ...
            .update(
                ...
                RecordQuery.builder().fields("id,title").build());
  ...
  void getCollectionBuildsFieldsQueryOption() {
    JsonNode collection =
        client.collections().getOne("posts", ListOptions.builder().fields("id,name").build());
  ...
  void collectionImportAndTruncateUseOfficialRoutes() {
    ...
    client
        ...
        .importCollections(
            Map.of(
                "deleteMissing", true, "collections", java.util.List.of(Map.of("name", "posts"))));
  ...
  void authWithPasswordStoresBearerTokenForLaterRequests() throws Exception {
    AuthResponse response =
        client.collection("users").authWithPassword("demo@example.com", "secret");
  ...
  void nonSuccessResponseThrowsPocketBaseException() {
    PocketBaseException exception =
        assertThrows(PocketBaseException.class, () -> client.collection("fail").list());
