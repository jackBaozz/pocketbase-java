...
class ExternalDatabaseSupportTest {
  ...
  void resolvesGenericDbPropertiesBeforePrefixSpecificValues() {
    ...
    ExternalDatabaseSupport.ResolvedConfig resolved =
        ExternalDatabaseSupport.resolve("mysql", properties::get, key -> null);
  ...
  void resolvesPrefixSpecificAndTestEnvironmentAliases() {
    ...
    ExternalDatabaseSupport.ResolvedConfig resolved =
        ExternalDatabaseSupport.resolve("postgres", key -> null, env::get);
  ...
  void returnsNullWhenNoExternalConfigurationExists() {
    ExternalDatabaseSupport.ResolvedConfig resolved =
        ExternalDatabaseSupport.resolve("mysql", key -> null, key -> null);
