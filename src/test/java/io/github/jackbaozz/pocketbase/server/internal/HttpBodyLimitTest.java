...
class HttpBodyLimitTest {
    ...
    void collectionBodyLimitIncludesOfficialFieldAllowances() {
        ...
        assertEquals(DEFAULT_LIMIT, HttpApi.collectionBodyLimit(Map.of(
                "type", "base",
                "fields", List.of()
        )));
        assertEquals(DEFAULT_LIMIT, HttpApi.collectionBodyLimit(Map.of(
                "type", "view",
                "fields", List.of(Map.of("type", "file", "maxSize", 100_000_000L))
        )));
        ...
        long expected = DEFAULT_LIMIT
                ...
                + 2L * (1L << 20)
                + (1L << 20);
        assertEquals(expected, HttpApi.collectionBodyLimit(Map.of(
                "type", "base",
                "fields", List.of(
