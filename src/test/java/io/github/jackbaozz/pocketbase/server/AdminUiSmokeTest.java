...
public class AdminUiSmokeTest {
  ...
  void testAdminUiIndexPageLoading() throws Exception {
    ...
    HttpRequest requestIndex =
        HttpRequest.newBuilder().uri(URI.create(baseUrl + "/_/")).GET().build();
    HttpResponse<String> responseIndex =
        httpClient.send(requestIndex, HttpResponse.BodyHandlers.ofString());
    ...
    HttpRequest requestIndexHtml =
        HttpRequest.newBuilder().uri(URI.create(baseUrl + "/_/index.html")).GET().build();
    HttpResponse<String> responseIndexHtml =
        httpClient.send(requestIndexHtml, HttpResponse.BodyHandlers.ofString());
  ...
  void testAdminUiAssetsServing() throws Exception {
    ...
    HttpRequest requestJs =
        HttpRequest.newBuilder().uri(URI.create(baseUrl + matcher.group(1))).GET().build();
    HttpResponse<String> responseJs =
        httpClient.send(requestJs, HttpResponse.BodyHandlers.ofString());
  ...
  void testAdminUiSuperuserWorkflowParity() throws Exception {
        ...
        HttpRequest.newBuilder()
            ...
            .POST(
                HttpRequest.BodyPublishers.ofString(
                    "{\"email\":\"ui-smoke@example.com\",\"password\":\"password123\"}"))
            .build();
    HttpResponse<String> bootstrapRes =
    ...
    HttpRequest login =
        HttpRequest.newBuilder()
            ...
            .POST(
                HttpRequest.BodyPublishers.ofString(
                    "{\"identity\":\"ui-smoke@example.com\",\"password\":\"password123\"}"))
            .build();
    ...
    HttpRequest settingsReq =
        HttpRequest.newBuilder()
            ...
            .GET()
            .build();
    HttpResponse<String> settingsRes =
        httpClient.send(settingsReq, HttpResponse.BodyHandlers.ofString());
