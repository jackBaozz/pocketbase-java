...
class ViewQuerySupportTest {
    ...
    void normalizesSingleSelectWithoutRejectingFunctionStars() {
        ...
        assertEquals(
                ...
                ViewQuerySupport.normalizeSingleSelect("select /* explicit columns */ id, title from posts")
        );
    }
    ...
    void rejectsMultipleStatementsAndWildcardColumns() {
        assertEquals(
                ...
                assertThrows(
                        ...
                        () -> ViewQuerySupport.normalizeSingleSelect("select id from posts; select id from posts")
                ).getMessage()
        );
        assertEquals(
